    ...
    private void rating(){
        ...
        try {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("########################################" + getApplicationContext().getPackageName())));
        }
    }

    private void feedbacks(){
        Intent intent=new Intent(Intent.ACTION_SEND);
        String[] recipients={"getkptsdevelopers@gmail.com"};
        intent.putExtra(Intent.EXTRA_EMAIL, recipients);
        intent.putExtra(Intent.EXTRA_SUBJECT,"Tic Tac Toe Feedbacks");
        intent.putExtra(Intent.EXTRA_CC,"getkptsdevelopers@gmail.com");
